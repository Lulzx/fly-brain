...
//   DNg100 dose    the two BDN2/DNg100 cells at 10, 20, 40 mV, on top of the scheduler's own walking
//                  drive to the same cells (the scheduler holds a walking bout on walk_cpg)
...
//   decapitation   every head superclass ablated (group:brain), the cord and its afferents live
...
//   DNg93, DNge036 the sibling programme's two predictions, driven on the rest site at 40 mV
//
...
export default {
  ...
  perturbations: [
    ...
    { id: 'dng100_10',   kind: 'driveType', target: 'type:DNg100',       args: { mv: 10 } },
    { id: 'dng100_20',   kind: 'driveType', target: 'type:DNg100',       args: { mv: 20 } },
    ...
    { id: 'dng93_on',    kind: 'driveType', target: 'type:DNg93',        args: { mv: 40 } },
    { id: 'dnge036_on',  kind: 'driveType', target: 'type:DNge036',      args: { mv: 40 } },
  ],
  observables: [
    // the walking site
  ...
  responses: [
    ...
    { id: 'dng100_dose',        row: 'dng100_dose',        observable: 'speed',        perturbations: ['dng100_10', 'dng100_20', 'dng100_40'] },
    { id: 'b13_slowdown',       row: 'b13_slowdown',       observable: 'speed',        perturbations: ['b13_on'] },
    { id: 'decapitated_stands', row: 'decapitated_stands', observable: 'displacement', perturbations: ['headless'] },
